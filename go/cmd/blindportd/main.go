...
func main() {
	...
	upstream := flag.String("upstream", envDefault("BLINDPORT_UPSTREAM", "127.0.0.1:80"), "local upstream host:port to forward all streams to")
	...
	claimKind := flag.String("kind", envDefault("BLINDPORT_KIND", "ip"), "ip, port, or relay")
