...
func TestTwoRelayWorkersEstablishHealthyEdgeWhileOtherStalls(t *testing.T) {
	...
	plans := []workerPlan{
		{SubscriptionID: 1, RelayAddr: stalled.Addr().String(), Upstream: "127.0.0.1:1", Claim: claim},
		{SubscriptionID: 1, RelayAddr: healthy.Addr().String(), Upstream: "127.0.0.1:1", Claim: claim},
	}
