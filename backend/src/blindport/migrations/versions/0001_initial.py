...
def _subscription_public_id_default() -> sa.TextClause:
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Uuid(),
            nullable=False,
            server_default=_subscription_public_id_default(),
        ),
    ...
    op.create_index("ix_subscription_public_id", "subscription", ["public_id"], unique=True)
