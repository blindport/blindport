...
class ReminderDeliveryState(StrEnum):
    ...
    INVOICE_CREATION_AMBIGUOUS = "invoice_creation_ambiguous"
...
class ReminderDelivery(SQLModel, table=True):
    ...
    invoice_ciphertext: str | None = Field(default=None, sa_type=Text)
    invoice_key_version: str | None = Field(default=None, max_length=32)
    payment_hash: str | None = Field(default=None, max_length=64)
    price_sats: int | None = None
    provider: str | None = Field(default=None, max_length=64)
    provider_payment_status: str | None = Field(default=None, max_length=32)
    provider_delivery_status: str | None = Field(default=None, max_length=32)
    nwc_state: str | None = Field(default=None, max_length=32)
    nwc_preimage_hash: str | None = Field(default=None, max_length=64)
    nwc_retry_blocked: bool = False
    ...
    invoice_created_at: datetime | None = Field(default=None, sa_type=DateTime(timezone=True))
    paid_at: datetime | None = Field(default=None, sa_type=DateTime(timezone=True))
