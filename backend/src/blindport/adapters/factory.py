...
@lru_cache(maxsize=1)
def get_lnurl_adapter() -> CoinosLnurlAdapter:
    return CoinosLnurlAdapter(
        address=settings.LNURL_MERCHANT_ADDRESS,
        request_timeout_seconds=settings.LNURL_REQUEST_TIMEOUT_SECONDS,
    )
