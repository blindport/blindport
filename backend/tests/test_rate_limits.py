...
def test_domain_verification_and_client_enrollment_have_independent_scopes(
    ...
    first_verify = client.post("/api/v1/subscriptions/999999/verify-domain", headers=_auth(token))
    limited_verify = client.post("/api/v1/subscriptions/999999/verify-domain", headers=_auth(token))
    enrollment_body = {
